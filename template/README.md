...
написання правельних функцій. Які безперечно можна буде використовувати
в самому ANT.
...
(можуть бути винятки)
9. результати функціі легко опрацьовувати за типом, 

Я покашу приклади як робити не треба - йдеться про давні мої: write, opens
